...
int is_restricted(int tail_num, enum day today) 
{
    ...
    switch (tail_num)
    {
        case 0: ret = (today == MONDAY) ? 1 : 0; break;
        case 5: ret = (today == MONDAY) ? 1 : 0; break;
        case 1: ret = (today == TUESDAY) ? 1 : 0; break;
        case 6: ret = (today == TUESDAY) ? 1 : 0; break;
        case 2: ret = (today == WEDNESDAY) ? 1 : 0; break;
        case 7: ret = (today == WEDNESDAY) ? 1 : 0; break;
        case 3: ret = (today == THURSDAY) ? 1 : 0; break;
        case 8: ret = (today == THURSDAY) ? 1 : 0; break;
        case 4: ret = (today == FRIDAY) ? 1 : 0; break;
        case 9: ret = (today == FRIDAY) ? 1 : 0; break;  
    default:
        break;
    }
    return ret;
